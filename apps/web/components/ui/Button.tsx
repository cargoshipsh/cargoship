...
import { cn } from "@cargoship/lib/cn";
      ...
      className: cn(
        ...
        variant === "highlight" &&
          (disabled
            ...
            : "text-white bg-gradient-to-b from-slate-800 to-slate-900 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-slate-900 transition ease-in-out delay-50 hover:scale-105"),
        variant === "primary" &&
          (disabled
            ? "border border-transparent bg-gray-400 text-white"
            : "text-white bg-gradient-to-b from-slate-800 to-slate-900  hover:shadow-md focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-slate-900"),
