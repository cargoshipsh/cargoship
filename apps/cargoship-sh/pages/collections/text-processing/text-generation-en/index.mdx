...
import { GenerationEnDemo } from "@/components/models/GenerationEnDemo";
...
```
docker pull cargoshipsh/generation-en
```
...
```bash
docker run -p 80:80 --env API_KEY=CHANGE_ME cargoshipsh/generation-en
```
