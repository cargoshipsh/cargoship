...
const navigation = {
  ...
  social: [
    {
      name: "Twitter",
      href: "https://twitter.com/cargoship-sh",
      icon: (props: any) => (
    ...
    {
      name: "GitHub",
      href: "https://github.com/cargoship-sh/cargoship",
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
...
export default function Footer() {
  return (
    <footer className="border-t-2 border-white/20 bg-gray-900 pt-5" aria-labelledby="footer-heading">
