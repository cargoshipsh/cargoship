      ...
      <Controller
        ...
        render={({ field }: { field: any }) => (
          <RadioGroup className="flex flex-col justify-center" {...field}>
            <RadioGroup.Label className="pb-6 text-center text-lg font-bold text-slate-300 sm:text-xl md:text-2xl">
              {element.label}
            </RadioGroup.Label>
            <div
              className={clsx(
                ...
                <RadioGroup.Option
                  ...
                  className={({ checked, active }) =>
                    clsx(
                      ...
                      "xs:rounded-lg relative flex cursor-pointer rounded-md border bg-slate-700 py-3 shadow-sm transition-all ease-in-out hover:scale-105 focus:outline-none sm:p-4"
                    )
                  }>
                  {({ checked, active }) => (
                    <>
                      <div className="flex flex-1 flex-col justify-center">
                        <RadioGroup.Label as="span" className="mx-auto text-sm font-medium text-gray-200">
                          {num}
                        </RadioGroup.Label>
                      </div>
            ...
            <div className="xs:text-sm mt-2 flex justify-between  text-xs text-slate-400">
